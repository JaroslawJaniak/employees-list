      ...
      {data ? (
        <section className="lg:mx-6 ">
          ...
          <div className="grid grid-cols-12 gap-4">
            <button
              className={
                "  col-end-10 md:col-end-11 lg:col-end-12 text-white bg-gray-700 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 font-medium font-fantasy rounded text-sm px-5 py-1 lg:py-2.5 mb-2 w-24 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" +
